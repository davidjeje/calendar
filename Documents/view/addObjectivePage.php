...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <form action="index.php?folder=ObjectiveController&amp;file=directionSaveObjective" method="POST" class="form">
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <label for="family">Famille de l'objectif</label>
                    <input type="text" class="form-control" placeholder="famille" id="family" name="family" required>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Ajout d'un objectif</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <p>Vous êtes sur le point d'ajouter un objectif.</p>
