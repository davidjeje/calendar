...
<head>
    ...
    <title><?php http_response_code(400)?></title>
...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="alert alert-danger" role="alert">
            <?= $displayMessage ?> <a href="index.php?folder=MonthController&amp;file=directionDisplayYear">Clic ici si tu souhaites aller sur la page d'acceuil.</a>
        </div>             
    </div> 
    <br>
    <!-- footer -->
