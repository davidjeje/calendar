...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <h1>Modifier ou supprimer cette tâche </h1>
        <form action="index.php?folder=TaskController&amp;file=directionUpdateValidateTask" method="POST" class="form">
            <div class="row">
                <div class="col-6">
                    <label for="name">Titre</label>
                    <input type="hidden" id="idTask" name="idTask" value="<?=$oneTask->id()?>">
                    <input type="text" class="form-control" placeholder="Titre" id="name" name="name" value="<?=$oneTask->name()?>" required>
                </div>
                <div class="col-6">
                    <label for="date">Date</label>
                    <input type="date" class="form-control" placeholder="date" id="date" name="date" value="<?=$oneTask->date()?>" required>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <label for="hour">Heure</label>
                    <input type="time" class="form-control" require placeholder="HH:MM" id="hour" name="hour" value="<?=$oneTask->hour()?>" required>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <label for="description">Description</label>
                    <textarea class="form-control" placeholder="Description" id="description" name="description" value="<?=$oneTask->description()?>" required><?=$oneTask->description()?></textarea>
                </div> 
            </div>
            <br>
            <div class="row">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Modification d'une tâche</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <p>Vous êtes sur le point de modifier cette tâche.</p>
                ...
                <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Suppression d'une tâche</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
