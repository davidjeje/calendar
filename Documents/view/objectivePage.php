...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-4" href="index.php?folder=ObjectiveController&amp;file=directionAddObjective">Ajouter un objectif</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <div class="row tm-mb-90 tm-gallery">
            <?php
            foreach($allObjectives as $k => $allObjective)
            {?>
                <div id="accordion">
                    <div class="card">
                        ...
                        <div id="collapse<?=$k?>" class="collapse " aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto mr-auto">
                                    <strong>Famille:<?= $allObjective->family();?></strong><br> Voici l'objectif: <?= $allObjective->description();?> 
                                    </div>
                                    <div class="col-auto">
                                        <button type="button" class="btn btn-outline-success" ><a href="index.php?folder=ObjectiveController&amp;file=directionEditObjective&amp;idObjective=<?= $allObjective->id();?>">Modifier</a></button>
                                        <button type="button" class="btn btn-outline-danger"><a href="index.php?folder=ObjectiveController&amp;file=directionDeleteObjective&amp;idObjective=<?= $allObjective->id();?>">Supprimer</a></button>  
                                    </div>
                                </div>
                            </div>
                        </div>
