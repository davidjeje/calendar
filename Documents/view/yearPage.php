    ...
    <div class="container-fluid tm-container-content tm-mt-60">
            ...
            { ?>
        	    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                    <figure class="effect-ming tm-video-item">
                        <img src="public/img/<?=$imgs[$i]?>" alt="Image" class="img-fluid">
                        <figcaption class="d-flex align-items-center justify-content-center">
                            <h2><?= $month[$i] .' '. year() ?></h2>
                            <a href="index.php?folder=MonthController&amp;file=directionDisplayMonth&amp;idMonth=<?=$i + 1?>&amp;year=<?=year()?>"><?= $month[$i] ?></a>
                        </figcaption>                    
                    </figure>
                    <div class="d-flex justify-content-between tm-text-gray">
                        <span class="tm-text-gray-light"><?= $month[$i] ?></span>
                    </div>
                </div>
            <?php
            }
        ...
        <div class="row tm-mb-90">
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                <a href="index.php?folder=MonthController&amp;file=directionDisplayYear&amp;year=<?=previousYear()?>" class="btn btn-primary tm-btn-prev ">précédent</a>
                
                <a href="index.php?folder=MonthController&amp;file=directionDisplayYear&amp;year=<?=nextYear()?>" class="btn btn-primary tm-btn-next">suivant</a>
            </div>            
        </div>
